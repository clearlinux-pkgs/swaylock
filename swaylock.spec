...
Version  : 1.7.1
Release  : 8
URL      : https://github.com/swaywm/swaylock/archive/v1.7.1/swaylock-1.7.1.tar.gz
Source0  : https://github.com/swaywm/swaylock/archive/v1.7.1/swaylock-1.7.1.tar.gz
...
%prep
%setup -q -n swaylock-1.7.1
cd %{_builddir}/swaylock-1.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674840336
unset LD_AS_NEEDED
