...
Version  : 1.6
Release  : 6
URL      : https://github.com/swaywm/swaylock/archive/1.6/swaylock-1.6.tar.gz
Source0  : https://github.com/swaywm/swaylock/archive/1.6/swaylock-1.6.tar.gz
...
%prep
%setup -q -n swaylock-1.6
cd %{_builddir}/swaylock-1.6
...
cp %{_builddir}/swaylock-1.6/LICENSE %{buildroot}/usr/share/package-licenses/swaylock/841449f83a67bf0e5197b94f9b9b61eb3ff097e0
