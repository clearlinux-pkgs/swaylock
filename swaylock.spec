...
Version  : 1.7
Release  : 7
URL      : https://github.com/swaywm/swaylock/archive/1.7/swaylock-1.7.tar.gz
Source0  : https://github.com/swaywm/swaylock/archive/1.7/swaylock-1.7.tar.gz
...
%prep
%setup -q -n swaylock-1.7
cd %{_builddir}/swaylock-1.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669833006
unset LD_AS_NEEDED
